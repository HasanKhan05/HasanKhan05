...
My long-term direction is the intersection of **AI and cybersecurity**: building useful systems, understanding their weaknesses, and helping make them safer. I’m based in **Karachi, Pakistan**, and I’m always open to learning from researchers, engineers, students, and builders working on meaningful technology.

<div align="center">

```text
learn → build → test → break → understand → secure → repeat
```
...
<table>
  <tr>
    <td width="33%" align="center">
      ...
      <p>Exploring AI, machine learning, and data-driven approaches to practical problems.</p>
    </td>
    <td width="33%" align="center">
      <h3>🔐 AI Security</h3>
      <p>Learning how intelligent systems can be evaluated, challenged, and made more trustworthy.</p>
    </td>
    <td width="33%" align="center">
      <h3>⚙️ Software Engineering</h3>
      <p>Building full-stack applications and APIs with maintainable, dependable foundations.</p>
    </td>
  </tr>
</table>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/HasanKhan05/HasanKhan05/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/HasanKhan05/HasanKhan05/output/github-contribution-grid-snake.svg" />
  <img alt="Animated snake eating HasanKhan05's GitHub contributions" src="https://raw.githubusercontent.com/HasanKhan05/HasanKhan05/output/github-contribution-grid-snake.svg" />
</picture>
...
<img src="https://komarev.com/ghpvc/?username=HasanKhan05&label=Profile%20views&color=ff7a00&style=flat-square" alt="Profile views" />
